            ...
            <div className="container">
                <footer className="row py-5 border-top" style={{ borderColor: 'rgba(255,255,255,0.06) !important' }}>
                    <div className="col-lg-4 mb-4">
                        ...
                        <p style={{ color: 'var(--neutral-500)' }} className="mt-4 mb-0">© {new Date().getFullYear()} Explorion Inc.</p>
                    </div>
                    ...
                    <div className="col-lg-2 offset-lg-2 mb-4">
                        ...
                        <ul className="nav flex-column">
                            <li className="nav-item mb-2"><Link to="/" className="nav-link p-0" style={{ color: 'var(--neutral-400)', transition: 'color 0.2s ease' }}>Home</Link></li>
                            <li className="nav-item mb-2"><Link to="/campgrounds" className="nav-link p-0" style={{ color: 'var(--neutral-400)', transition: 'color 0.2s ease' }}>Campgrounds</Link></li>
                            <li className="nav-item mb-2"><Link to="/user/register" className="nav-link p-0" style={{ color: 'var(--neutral-400)', transition: 'color 0.2s ease' }}>Sign Up</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-lg-4 mb-4">
                        ...
                        <ul className="nav flex-column mb-3">
                            <li className="nav-item mb-2" style={{ color: 'var(--neutral-400)' }}>
                        ...
                        <div className="d-flex gap-3 mt-3">
                            <a href="#" className="fs-4" style={{ color: 'var(--neutral-400)', transition: 'color 0.2s ease, transform 0.2s ease' }}><i className="bi bi-twitter"></i></a>
                            <a href="#" className="fs-4" style={{ color: 'var(--neutral-400)', transition: 'color 0.2s ease, transform 0.2s ease' }}><i className="bi bi-instagram"></i></a>
                            <a href="#" className="fs-4" style={{ color: 'var(--neutral-400)', transition: 'color 0.2s ease, transform 0.2s ease' }}><i className="bi bi-facebook"></i></a>
                        </div>
                    </div>
                </footer>
            </div>
